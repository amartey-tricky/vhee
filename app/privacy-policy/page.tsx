...
export default function Page() {
  return (
    <main className="min-h-screen py-24">
      <section className="px-4 md:px-6 lg:px-10 text-justify flex flex-col items-center justify-between max-w-2xl mx-auto space-y-8">
        ...
        <ul>
          ...
          <li>
            <p>
              ...
              in this Agreement) refers to VheeWorld Foundation, 1 Adogono
              Street.
            </p>
          </li>
          <li>
          ...
          <li>
            <p>
              <strong>Website</strong> refers to VheeWorld, accessible from{" "}
              <Link
                href="https://vheeworld.org"
        ...
        <ul>
          <li>
            <p>By email: <Link className="text-blue-500 underline" href="mailto:vheeworld@gmail.com">vheeworld@gmail.com</Link></p>
          </li>
          <li>
            <p>
              By visiting this page on our website:{" "}
              <Link
                href="https://vheeworld.org/contact"
                rel="external nofollow noopener noreferrer"
                target="_blank"
                className="text-blue-500 underline"
              >
                https://vheeworld.org/contact
              </Link>
            </p>
          </li>
        </ul>
