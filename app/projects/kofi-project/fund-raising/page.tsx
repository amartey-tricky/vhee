...
export default async function Page() {
  const { resources } = await v2.search.expression("folder:funderaising").execute();

  return (
    <main className="container mx-auto py-8 px-12 md:px-24">
      <h1 className="text-3xl font-bold mb-8">Kofi Project - Fund Raising & Mental Health Seminar</h1>
