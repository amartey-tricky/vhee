...
export function Footer() {
  return (
    <footer className="bg-blue-500 text-gray-200 md:bg-transparent md:text-slate-400 md:mt-24">
      <div className="w-full max-w-screen-xl mx-auto p-4 md:p-8">
        ...
        <div className="sm:flex sm:items-center sm:justify-between">
          ...
          <div className="flex mt-4 space-x-6 sm:justify-center sm:mt-0">
            ...
            <Link
              href="https://www.linkedin.com/in/vheeworld-foundation-938238246/?trk=people_directory&originalSubdomain=gh"
              className="md:text-gray-500 hover:text-gray-900"
            >
              <svg
                className="w-5 h-5"
